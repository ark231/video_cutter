...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow) {
    ...
    connect(ui->timeEdit_current_time, &QTimeEdit::userTimeChanged, [=](QTime time) {
        ...
        this->update_video_position_slider_(new_position);
        this->change_video_position_(new_position);
    });
...
void MainWindow::update_video_position_display_(std::chrono::seconds newposition) {
    using std::chrono::duration_cast;
    using std::chrono::milliseconds;
    using std::chrono::seconds;
...
void MainWindow::change_video_position_(std::chrono::seconds newposition) {
    using std::chrono::duration_cast;
    using std::chrono::milliseconds;
    using std::chrono::seconds;
